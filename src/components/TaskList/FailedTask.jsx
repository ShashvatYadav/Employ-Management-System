    ...
    return (
        <div className="flex-shrink-0 w-[350px] p-5 bg-[#333333] rounded-lg shadow-lg">
            <div className="flex items-center justify-between mb-3">
                <span className="px-3 py-1 text-sm font-semibold text-white bg-[#db4f4f] rounded-full">
                    {data.taskCategory}
                </span>
            ...
            <div className="flex justify-start">
                <span className="px-4 py-2 text-white font-semibold bg-[#cc3f3f] rounded-lg shadow-md">
                    Failed
                </span>
            </div>
        </div>
